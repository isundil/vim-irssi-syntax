...
" -- syn match m_error /[})][^ \t]*[^;])/
" Keywords & Statements
syn keyword irssi_keywords servers chatnets channels settings aliases statusbar
syn region irssi_category start="=[ \t]*(" end=")" fold transparent contains=irssi_servers,irssi_chatnets,irssi_channels,irssi_statusbar,irssi_settings,value_def,m_error
syn region irssi_category start="=[ \t]*{" end="}" fold transparent contains=irssi_servers,irssi_chatnets,irssi_channels,irssi_statusbar,irssi_settings,value_def,m_error
syn keyword irssi_servers address chatnet port
syn keyword irssi_chatnets type max_kicks max_msgs max_whois aliases statusbar contained
syn keyword irssi_channels name chatnet autojoin contained
...
syn keyword irssi_settings core real_name user_name nick fe-text actlist_sort contained
